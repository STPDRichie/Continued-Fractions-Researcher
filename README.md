...
2. Количество этажей у дроби или диапазон значений.
3. Диапазон значений неполных частных.
4. Точность диаграммы распределения. Например, 0.05, значит диаграмма будет считать значения, попавшие в отрезок [n; n + 0.05].
